...
//            Response response = admin.perform(apiClient -> new CreatePlayerAction(apiClient, playerRequestDTO));
...
//            Response response = admin.perform(apiClient -> new GetOnePlayerAction(apiClient, request));
...
//            Response response = admin.perform(GetAllPlayersAction::new);
...
//            Response deleteResponse = admin.perform(apiClient -> new DeletePlayerAction(apiClient, playerBeingDeleted.id()));
//
//            SoftAssertions.assertSoftly(softly -> {
...
//                Response getResponse = admin.perform(apiClient ->
